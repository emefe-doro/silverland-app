...
export const NAV: NavItem[] = [
  { href: "/dashboard", label: "Dashboard", icon: "LayoutDashboard", roles: ["SUPER_ADMIN", "ESTATE_MANAGEMENT", "SECURITY_OFFICER", "RESIDENT"] },
  { href: "/gate", label: "Gate Control", icon: "ShieldCheck", roles: ["SUPER_ADMIN", "SECURITY_OFFICER"] },
  { href: "/visitors", label: "Visitors", icon: "Users", roles: ["SUPER_ADMIN", "ESTATE_MANAGEMENT", "SECURITY_OFFICER"] },
